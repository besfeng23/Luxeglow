      ...
      <section className="pt-48 pb-24 overflow-hidden">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-5xl mx-auto text-center space-y-12 animate-fade-in-up">
            <span className="text-[10px] uppercase tracking-[0.8em] font-bold text-accent block">The Atelier Gallery</span>
            ...
            {filteredItems.map((item) => (
              <Dialog key={item.id}>
                ...
                <DialogContent className="max-w-6xl bg-transparent border-none p-0 shadow-none">
                  <div className="relative aspect-video lg:aspect-[16/9] w-full rounded-[4rem] overflow-hidden luxury-shadow">
                    <Image 
                      src={item.image} 
                      alt={item.title} 
                      fill 
                    ...
                    <div className="absolute bottom-12 left-12 right-12 text-white z-10">
                      <div className="bg-black/20 backdrop-blur-xl p-10 rounded-[2.5rem] border border-white/10 max-w-xl">
                        <span className="text-[10px] uppercase tracking-[0.5em] font-bold text-accent mb-4 block">{item.category}</span>
                        <h3 className="font-headline text-5xl italic font-light leading-tight">{item.title}</h3>
                        <div className="h-px w-16 bg-white/20 my-6" />
                        <p className="text-white/60 text-sm italic font-light">Experience the private clinical boutique standard at Estancia Mall.</p>
                      </div>
                    </div>
                  </div>
                </DialogContent>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
             <div className="space-y-16">
               <div className="space-y-8">
                 <Star className="w-12 h-12 text-accent fill-accent/20 animate-pulse" />
                 <h2 className="font-headline text-6xl md:text-8xl italic font-light leading-tight">"A space where <br /><span className="text-accent">artistry</span> meets tranquility."</h2>
               </div>
               <p className="text-white/40 text-2xl font-light leading-relaxed italic border-l border-white/10 pl-10 max-w-xl">
             ...
             <div className="relative group">
                <div className="aspect-[3/4] rounded-[5rem] overflow-hidden luxury-shadow relative border-[20px] border-white/5">
                   <Image 
                ...
                <div className="absolute -top-12 -right-12 w-48 h-48 bg-accent/10 rounded-full blur-[100px] pointer-events-none" />
             </div>
          </div>
        </div>
      ...
      <section className="py-40 bg-white">
        <div className="container mx-auto px-6 lg:px-12 text-center">
          <div className="max-w-3xl mx-auto space-y-16">
            ...
            <p className="text-[10px] uppercase tracking-[0.5em] text-muted-foreground/60 pt-10 font-bold">Luxe Glow Premier • Private Aesthetic Intelligence</p>
          </div>
        </div>
      </section>
    </div>
